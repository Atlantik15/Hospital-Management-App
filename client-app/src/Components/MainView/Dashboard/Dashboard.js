    ...
    <div>
      ...
      >
        <GridItem xs={4} style={{ position: "relative", right: "85px" }}>
          <h2 style={{ position: "relative", right: "20px" }}>
            Hello Dr.Jane Doe
          </h2>
        ...
        <GridItem xs={2}>
          <Card className={classes.cardInfo}>
            <Card
              className={classes.lComponents}
              style={{ backgroundColor: "#f3ecfb" }}
            >
              <CardBody position="absolute" top="50%" right="50%">
                <img
                  src="https://image.flaticon.com/icons/png/512/3034/3034878.png"
                  height="55px"
                  width="55px"
                  margin="0"
                />
        ...
        <GridItem xs={2}>
          <Card className={classes.cardInfo}>
            <Card
              className={classes.lComponents}
              style={{ backgroundColor: "#fee8ed" }}
            >
              <CardBody position="absolute" top="50%" right="50%">
                <img
                  src="https://image.flaticon.com/icons/png/512/2397/2397594.png"
                  height="50px"
                  width="50px"
                  margin="auto"
                />
        ...
        <GridItem xs={2}>
          <Card className={classes.cardInfo}>
            <Card
              className={classes.lComponents}
              style={{ backgroundColor: "#fecb90" }}
            >
              <CardBody position="absolute" top="50%" right="50%">
                <img
                  src="https://image.flaticon.com/icons/png/512/3304/3304567.png"
                  height="50px"
                  width="50px"
                  margin="auto"
                />
        ...
        <GridItem xs={2}>
          <Card className={classes.cardInfo}>
            ...
            >
              <CardBody position="absolute" top="50%" right="50%">
                <img
                  src="https://image.flaticon.com/icons/png/512/3063/3063176.png"
                  height="50px"
                  width="50px"
                  margin="auto"
                />
      ...
      <GridContainer spacing={2}>
        ...
        <GridItem
          xs={4}
          style={{ position: "relative", right: "-5px", top: "-85px" }}
        >
