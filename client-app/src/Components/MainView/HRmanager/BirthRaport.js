...
const BirthRaport = ({ classes, ...props }) => {
  ...
  const { TblContainer, TblPagination } = useTable();
  ...
  const onDelete = (id) => {
    if (window.confirm("Are you sure to delete this record?"))
      props.deleteBirthRaport(id, () =>
        addToast("Deleted successfully", { appreance: "info" })
      );
  };
  ...
  return (
    <>
      <PageHeader
        title="New Birth Raport"
        subTitle="Manage Birth Raports"
