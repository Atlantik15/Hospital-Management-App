...
const BirthRaportForm = ({ classes, ...props }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (validate()) {
      ...
      if (props.currentId == 0) props.createBirthRaport(values, onSuccess);
      else props.updateBirthRaport(props.currentId, values, onSuccess);
    }
  };
...
export default connect(
  mapStateToProps,
  mapActionToProps
)(withStyles(styles)(BirthRaportForm));
