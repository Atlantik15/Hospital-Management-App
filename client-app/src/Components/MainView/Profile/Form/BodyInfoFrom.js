    ...
    >
      ...
      <Form.Field>
        <input
          placeholder="Weight..."
          name="weight"
          value={bodyinfo.pesha}
          onChange={handleInputChange}
        />
      </Form.Field>
      <Form.Field>
        <input
          placeholder="Bood Group..."
          name="grupiGjakut"
          value={bodyinfo.grupiGjakut}
          onChange={handleInputChange}
        />
      </Form.Field>
      <Form.Field>
      ...
      <Button onClick={cancelSelectedBodyInfo} type="button" color="gray">
        Cancel
      </Button>
    </Form>
  );
