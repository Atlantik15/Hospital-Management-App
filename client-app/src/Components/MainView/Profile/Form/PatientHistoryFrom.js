...
export default observer(function PatientHistoryFrom() {
  ...
  function handleSubmit() {
    patientHistory.id
      ...
      : createPatientHistory(patientHistory);
  }
      ...
      >
        ...
        >
          <Form.Field>
            <label>Date</label>
            <input
              placeholder="Date of history.."
              value={patientHistory.date}
              name="date"
          ...
          <Form.Field>
            ...
            <textarea
              placeholder="Description of history..."
              style={{
                marginRight: "20px",
                marginLeft: "20px",
                width: "400px",
              ...
              value={patientHistory.descritpion}
              name="descritpion"
              onChange={handleInputChange}
            />
          </Form.Field>
          ...
          <Button
            onClick={cancelSelectedPatientHistory}
            type="button"
            color="gray"
            style={{ height: "40px", marginTop: "30px" }}
          >
