        ...
        >
          ...
          <Form.Field>
            <textarea
              ...
              value={labtest.location}
              name="location"
              onChange={handleInputChange}
            />
          </Form.Field>
        </TableRow>
        <Button loading={loading} type="submit" variant="primary" color="green">
          Submit
        </Button>
        <Button onClick={cancelSelectedLabTest} type="button" color="gray">
          Cancel
        </Button>
      </Form>
    </Segment>
