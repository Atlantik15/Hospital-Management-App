          ...
          <p.Proccedures>
            <div>
              <div class="upper-container">
                ...
                />
                <p class="pline" style={{ marginRight: "45%" }}>
                  Procedures
                </p>
                <Button
                  onClick={() => proceduresStore.openProcedureForm()}
                  color="blue"
                  width="1"
                >
                  <b>
        ...
        <div class="right-container">
          <p.Allergy>
            <div>
              <div class="upper-container">
                ...
                <Button
                  onClick={() => allergiesStore.openAllergyForm()}
                  color="blue"
                  style={{ marginLeft: "71%" }}
                >
                  + Add Allergy
          ...
          <p.History>
            <div class="upper-container">
              ...
              <Button
                onClick={() => patientHistoryStore.openHistoryForm()}
                color="blue"
              >
                + Add
              </Button>
