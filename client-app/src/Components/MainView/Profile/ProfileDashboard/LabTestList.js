      ...
      <TableBody>
        {labtestsByName.map((labtest) => (
          <TableRow key={labtest.id}>
            <TableCell style={{ width: "200px", color: "purple" }}>
              <b>{labtest.name}</b>
            </TableCell>
            <TableCell>
              <TableRow>
                ...
                <TableCell>{labtest.date}</TableCell>
              </TableRow>
              <TableRow>
                <p
                  style={{
                ...
                <TableCell>{labtest.location}</TableCell>
              </TableRow>
            </TableCell>
            <TableCell></TableCell>
            <TableCell>
              {user.role === "admin" && (
                <ButtonGroup
                  variant="text"
                  style={{ width: "165px", marginLeft: "100px" }}
                >
                  <Button
                    onClick={() => labTestStore.selectLabTest(labtest.id)}
                    basic
                    color="purple"
                  >
                    Edit
                  ...
                  <Button
                    ...
                    onClick={(e) => handleLabTestDelete(e, labtest.id)}
                    basic
                    color="black"
                  >
