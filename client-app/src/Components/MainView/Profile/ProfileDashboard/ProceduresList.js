        ...
        <body>
          {proceduresByDate.map((procedure) => (
            <tr class="tabela">
              <tr key={procedure.id}>
                <td>Procedure</td>
                <td style={{ width: "150px", color: "purple" }}>
                  <b>{procedure.name}</b>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>
                  <p style={{ marginRight: "30px" }}>Location on Body:</p>
                </td>
                <td style={{ marginBottom: "20px", marginLeft: "20px" }}>
                  <b>{procedure.locationOnBody}</b>
                </td>
              </tr>
              <br></br>
              <tr>
                <ButtonGroup class="ui small basic icon buttons">
                  <Button
                    basic
                    onClick={() =>
                      proceduresStore.selectProcedure(procedure.id)
                    }
                    class="ui button"
                  >
                    <i class="edit icon"></i>
                  ...
                  <Button
                    ...
                    onClick={(e) => handleProcedureDelete(e, procedure.id)}
                    class="ui button"
                  >
